import java.io.*;
public class movieandsnackbar
{
 public static void main()throws IOException
 {
  BufferedReader br=new BufferedReader(new InputStreamReader(System.in));
  String title="******************WELCOME TO GRANDVIEW CINEMA*****************";
  String list[]=new String[19];//for Storing Movie names.
  list[0]="MARY KOM";list[1]="TWILIGHT";list[2]="A CHRISTMAS CAROL";list[3]="FINDING FANNY";
  list[4]="2012";list[5]="AJAB PREM KI GHAJAB KAHANI";
  list[6]="EK NIRANJAN";list[7]="AARYA 2";list[8]="KANDEIN KADHALAI";list[9]="PARICHAYA";
  list[10]="MAGADHEERA";list[11]="AADHAVAN";  list[12]="PAJHASSIRAJA";list[13]="CHENNAI EXPRESS";
  list[14]="KURRADU";list[15]="JULIE AND JULIA";list[16]="MOORU GUTTO ONDHU SULLU";
  list[17]="VILLAGE LO VINAYAKUDU";list[18]="MANASAARE";
  String city[]=new String[6];//for Storing City names.
  city[0]="BANGALORE";city[1]="CHANDIGARH";city[2]="DELHI";city[3]="HYDERABAD";city[4]="MUMBAI";
  city[5]="KOLKATA";  String cityN,movie,size;//declaration of String variables  String ans="Q";
  String ans1="Q";
  int flag=0,flag1=0,flag2=0,flag3=0,flag4=0,catg,quantity,date,bvrg,tot_bvrg,snck,tot_snck,fd,cn;
  ...
  do
  {
   ...
   {
    System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
    System.out.println("** 1.GRANDVIEW "+cityN+" CLASSIC CINEMAS **");
    System.out.println("** 2.GRANDVIEW "+cityN+" SUPER CLASSIC CINEMAS **");
    System.out.println();
   ...
   System.out.println("FOR INTERNATE BOOKING VISIT:http://www.Grandviewcinemas.com");
   System.out.println();
   System.out.println("** CATCH THE LATEST MOVIES AT GRANDVIEW CINEMAS NEAR YOU **");
   System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
   System.out.println();
   ...
   {
    System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
    System.out.println("** 1. THURSDAY, 26 NOVEMBOR [2009] **");
    System.out.println("** 2. FRIDAY,   27 NOVEMBOR [2009] **");
    System.out.println("** 3. SATURDAY, 28 NOVEMBOR [2009] **");
    System.out.println("** 4. SUNDAY,   29 NOVEMBOR [2009] **");
    System.out.println("** 5. MONDAY,   30 NOVEMBOR [2009] **");
   ...
   if(catg==1)
   {
    ...
    do
    {
     ...
     System.out.println();
     System.out.println("MARY KOM                        A          HINDI       01:00pm,9:15pm");
     System.out.println("TWILIGHT                       U/A        ENGLISH     06:15pm");
     System.out.println("A CHRISTMAS CAROL              U          ENGLISH     03:20pm");
     System.out.println("FINDING FANNY                  U/A        HINDI       06:15pm,9:20pm");
     ...
     System.out.println("CHENNAI EXPRESS                U          HINDI       03:40pm");
  ...
  do
  {
   System.out.println("*********** WELCOME TO THE SNACK BAR OF GRANDVIEW ************");
   System.out.println();
   ...
   if(flagC1.equalsIgnoreCase("Y"))
   {
    ...
    if(bvrg>=1 && bvrg<=7)
     ...
     System.out.println("THE TOTAL COST is Rs"+(tot_bvrg*55));
    else if (bvrg>=11 && bvrg<=12)
     System.out.println("THE TOTAL COST IS Rs"+(tot_bvrg*65));
    else if (bvrg>=13 && bvrg<=17)
     System.out.println("THE TOTAL COST IS Rs"+(tot_bvrg*75));
    System.out.println();
   }
   else
    System.out.println();
   ...
   if(flagC3.equalsIgnoreCase("Y"))
   {
    ...
    if(fd==33 || fd==34)
     ...
     System.out.println("TOTAL COST IS RS."+tot_fd*60);
    else if(fd==36 || fd==37)
     System.out.println("TOTAL COST IS RS."+tot_fd*86);
   }
...
{
 BufferedReader br = new BufferedReader (new InputStreamReader(System.in));
 int date,catg,quantity,seat_no,flag1=0,flag2=0,cn;
 ...
 {
  System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
  System.out.println("** 1.GRANDVIEW CLASSIC CINEMAS **");
  System.out.println("** 2.GRANDVIEW SUPER CLASSIC CINEMAS **");
  System.out.println();
  System.out.print("ENTER THE CORRECT CATEGORY NUMBER FOR YOUR CHOICE :");
  catg=Integer.parseInt(br.readLine());
  if((catg==1)||(catg==2))
 ...
 {
  case 1:
  System.out.println("***************** GRANDVIEW CLASSIC CINEMAS *********************");
   System.out.println();
  ...
  case 2:
  System.out.println("**************** GRANDVIEW SUPER CLASSIC CINEMAS *****************");
  System.out.println();
  System.out.println("<<< SELECT YOUR DATE FOR CANCELLATION >>>");
   do
   {
